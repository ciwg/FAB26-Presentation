...
check_url 09 'https://en.wikipedia.org/wiki/Manufacturing_execution_system' 'Manufacturing execution system'
...
check_url 15 'https://en.wikipedia.org/wiki/Content-addressable_storage' 'Content-addressable storage'
