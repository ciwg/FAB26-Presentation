...
[^mes]: Wikipedia, Manufacturing execution system: [https://en.wikipedia.org/wiki/Manufacturing_execution_system](https://en.wikipedia.org/wiki/Manufacturing_execution_system)
...
[^cas]: Wikipedia, Content-addressable storage: [https://en.wikipedia.org/wiki/Content-addressable_storage](https://en.wikipedia.org/wiki/Content-addressable_storage)
